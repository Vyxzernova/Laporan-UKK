...
<head>
    ...
    <title>UKK: UJIAN KALKULATOR</title>
</head>
<style>
        body {
            margin: 0;
...
<body>
    <center>
        ...
        <tr>
            <td>
                <h1>
                <center><font color="black">UKK UJIAN KALKULATOR</font></center>
            </h1>
        </td>
        </tr>
        <input type="text" name="text1" id="">
        <input type="button" value="=" onClick="form1.text1.value=eval(form1.text1.value)">
        <table>
            <tr>
				...
				<td><input type="reset" value="c" onCLick="form1.text1.value+=''"></td>
            ...
            <tr>
                ...
                <td><input type="button" value="000" onClick="form1.text1.value+='000'"></td>
